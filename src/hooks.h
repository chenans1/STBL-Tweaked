...
class hooks {
    public:
        ...
        static inline RE::EffectSetting* STBLTweakedStaggerMGEF = nullptr;
        static inline RE::SpellItem* STBLTweakedStaggerSpell = nullptr;
        ...
        static bool LoadForms() {
            ...
            STBLTweakedStaggerMGEF = dataHandler->LookupForm<RE::EffectSetting>(0x808, "SimpleTimedBlockTweaked.esp");
            STBLTweakedStaggerSpell = dataHandler->LookupForm<RE::SpellItem>(0x809, "SimpleTimedBlockTweaked.esp");
            ...
            if (!timedBlockMeleeAttackerSpell|| !timedBlockArrowAttackerSpell || !timedBlockSpellAttackerSpell || !STBLTweakedStaggerMGEF || !STBLTweakedStaggerSpell) {
                SKSE::log::error("Failed to load effect forms: timedBlockMeleeAttackerSpell={}, timedBlockArrowAttackerSpell={}, timedBlockSpellAttackerSpell={}, STBLTweakedStaggerMGEF={}, STBLTweakedStaggerSpell={}", 
                    ...
                    static_cast<void*>(STBLTweakedStaggerMGEF), static_cast<void*>(STBLTweakedStaggerSpell));
                return false;
            }
